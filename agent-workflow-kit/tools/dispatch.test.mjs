...
describe('dispatch CLI shell', () => {
  ...
  it('an unknown or absent verb is usage (exit 2), and the expected set names all eleven', () => {
    const unknown = main(['frobnicate'], {});
    assert.match(unknown.stderr, /unknown verb: frobnicate/);
    assert.match(unknown.stderr, /check \| advise \| register \| observe \| open \| await \| return \| fold \| degrade \| handoff-return \| aggregate/);
